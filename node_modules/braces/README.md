...
* **[fast and performant](#***REMOVED***chmarks)**: Starts fast, runs fast and [scales well](#performance) as patterns increase in complexity.
...
# ***REMOVED***chmark/fixtures/combination-nested.js (52 bytes)
...
# ***REMOVED***chmark/fixtures/combination.js (51 bytes)
...
# ***REMOVED***chmark/fixtures/escaped.js (44 bytes)
...
# ***REMOVED***chmark/fixtures/list-basic.js (40 bytes)
...
# ***REMOVED***chmark/fixtures/list-multiple.js (52 bytes)
...
# ***REMOVED***chmark/fixtures/no-braces.js (48 bytes)
...
# ***REMOVED***chmark/fixtures/sequence-basic.js (41 bytes)
...
# ***REMOVED***chmark/fixtures/sequence-multiple.js (51 bytes)
