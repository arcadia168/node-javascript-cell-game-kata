...
<!--            <add name="WebDAVModule" image="%IIS_BIN%\webdav.dll" /> -->
            ...
            <add name="ManagedEngine" image="%windir%\Microsoft.NET\Framework\v2.0.50727\we***REMOVED***gine.dll" preCondition="integratedMode,runtimeVersionv2.0,bitness32" />
            <add name="ManagedEngine64" image="%windir%\Microsoft.NET\Framework64\v2.0.50727\we***REMOVED***gine.dll" preCondition="integratedMode,runtimeVersionv2.0,bitness64" />
            <add name="ManagedEngineV4.0_32bit" image="%windir%\Microsoft.NET\Framework\v4.0.30319\we***REMOVED***gine4.dll" preCondition="integratedMode,runtimeVersionv4.0,bitness32" />
            <add name="ManagedEngineV4.0_64bit" image="%windir%\Microsoft.NET\Framework64\v4.0.30319\we***REMOVED***gine4.dll" preCondition="integratedMode,runtimeVersionv4.0,bitness64" />
        ...
        <security>
            ...
            <isapiCgiRestriction notListedIsapisAllowed="true" notListedCgisAllowed="true">
                <add path="%windir%\Microsoft.NET\Framework64\v4.0.30319\we***REMOVED***gine4.dll" allowed="true" groupId="ASP.NET_v4.0" description="ASP.NET_v4.0" />
                <add path="%windir%\Microsoft.NET\Framework\v4.0.30319\we***REMOVED***gine4.dll" allowed="true" groupId="ASP.NET_v4.0" description="ASP.NET_v4.0" />
