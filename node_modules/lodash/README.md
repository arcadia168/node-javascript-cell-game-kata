...
A utility library delivering consistency, [customization](http://lodash.com/custom-builds), [performance](http://lodash.com/***REMOVED***chmarks), & [extras](http://lodash.com/#features).
...
We’ve got [API docs](http://lodash.com/docs), [***REMOVED***chmarks](http://lodash.com/***REMOVED***chmarks), and [unit tests](http://lodash.com/tests).
