...
- [***REMOVED***chmarks](#***REMOVED***chmarks)
  * [Running ***REMOVED***chmarks](#running-***REMOVED***chmarks)
...
Nanomatch is part of a suite of libraries aimed at bringing the power and expressiveness of [Bash's](https://www.gnu.org/software/bash/) matching and expansion capabilities to JavaScript, _and - as you can see by the [***REMOVED***chmarks](#***REMOVED***chmarks) - without sacrificing speed_.
